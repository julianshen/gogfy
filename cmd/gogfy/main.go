...
func usage(w io.Writer) {
	fmt.Fprintln(w, "usage: gogfy run <root> [--update] [--out dir] [--directed] [--graphml] [--cypher] [--no-viz] [--wiki] [--tree] [--semantic --backend <name>] [--dry-run] [--max-cost-usd N] [--transcribe-backend <name>] [--follow-symlinks]")
	fmt.Fprintln(w, "       gogfy run --cluster-only [--out dir] [--directed] [--no-viz] [--wiki] [--tree]")
	fmt.Fprintln(w, "       gogfy clone <git-url> [--dir D] [--branch B] [--out dir] [--no-run]")
	...
	fmt.Fprintln(w, "       gogfy build-merge <prior.json> <next.json> [--files <list.txt>] [--out <merged.json>]")
	fmt.Fprintln(w, "       gogfy diff <old.json> <new.json>")
	fmt.Fprintln(w, "       gogfy ci <base.json> <head.json> [--max-removed-nodes N] [--max-removed-edges N] [--max-new-ambiguous N]")
	fmt.Fprintln(w, "       gogfy manifest <root> [--out <dir>] [--diff] [--follow-symlinks]")
	fmt.Fprintln(w, "       gogfy cache stats [--out <dir>]")
	fmt.Fprintln(w, "       gogfy cache clear [--out <dir>] [--older-than <dur> | --all]")
	fmt.Fprintln(w, "       gogfy ingest <url> [--out <dir>] [--audio]   (alias: gogfy add)")
	...
	fmt.Fprintln(w, "       gogfy site <graph.json> [--out <site-dir>] [--wiki-dir <existing-wiki>]")
	fmt.Fprintln(w, "       gogfy svg <graph.json> [--out <path.svg>] [--labels] [--width N] [--height N] [--iterations N]")
	fmt.Fprintln(w, "       gogfy neo4j-push <graph.json> [--uri <bolt-uri>] [--user U] [--password P] [--database D]")
